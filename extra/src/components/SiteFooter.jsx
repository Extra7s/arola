...
const SiteFooter = () => (
  ...
  >
    ...
    <div className="absolute -top-[20%] left-1/2 -translate-x-1/2 w-full h-full flex items-center justify-center z-50">
      <p className="uppercase font-poppins-bold text-white text-6xl md:text-8xl lg:text-[13rem] tracking-[0.05em]">
        arola
      </p>
    </div>
